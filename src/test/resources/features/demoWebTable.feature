Feature: Testing the demo web table page

  Background:
      Given user enter the url for the demo practice website
      Then user should land on the demo web table page

  Scenario: Verify that we have only 4 structure values
    Then verify that the number of structure values


    Scenario: Verify that the number of structure values equals to the total
